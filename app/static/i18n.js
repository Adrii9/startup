...
const STRINGS = {
  ca: {
    ...
    login_help: "Entra amb el teu usuari, o crea't un compte si és el primer cop.",
    tab_login: 'Entrar', tab_signup: 'Crear compte',
    user_label: 'Usuari', pass_label: 'Contrasenya',
    signup_hint: "L'usuari és el nom que veuran els altres. La contrasenya, 8 caràcters com a mínim.",
    login_go: 'Entrar', signup_go: 'Crear el compte', or_google: 'o bé',
    acc_password: 'Canviar la contrasenya',
    pw_title: 'Canviar la contrasenya', pw_current: 'Contrasenya actual', pw_new: 'Contrasenya nova',
    pw_repeat: 'Repeteix-la', pw_mismatch: 'Les dues contrasenyes noves no coincideixen.',
    pw_note: "Es tancarà la sessió a tots els altres navegadors on hagis entrat.",
    pw_done: 'Contrasenya canviada.',
    e_username_invalid: "L'usuari ha de tenir de 3 a 30 lletres, números, punts, guions o guions baixos, sense espais.",
    e_password_short: 'La contrasenya ha de tenir {n} caràcters com a mínim.',
    e_username_taken: 'Aquest usuari ja existeix.',
    e_bad_credentials: 'Usuari o contrasenya incorrectes.',
    e_too_many: 'Massa intents. Espera uns minuts i torna-ho a provar.',
    e_bad_current: 'La contrasenya actual no és correcta.',
    e_owns_shared: "Encara ets propietari de projectes on hi ha més gent: {names}. Passa'ls a algú altre o esborra'ls abans.",
    ...
    join_btn: 'Uneix-te al projecte', join_google: 'Entra o crea un compte per unir-te',
    ...
    files: 'Fitxers', no_files: 'Cap fitxer encara.', f_upload: 'Pujar fitxers',
    f_uploading: 'Pujant…', f_added_by: 'per {n}', f_version: 'v{v}',
    t_updated: '{n} actualitzat a v{v}.',
    f_text: 'es pot llegir', f_image: 'imatge', f_binary: 'només descarregar',
    f_empty: 'sense text (escanejat?)', f_error: 'no s\'ha pogut llegir',
    f_delete: 'Esborrar', f_delete_q: 'Esborrar «{n}»?',
    f_delete_body: "El fitxer desapareixerà del projecte i les IAs deixaran de poder-lo llegir. L'entrada del registre que diu que el vas pujar es queda.",
    f_open: 'Obrir',
    repos: 'Repositoris', no_repos: 'Cap repositori enllaçat.',
    repo_add: 'Enllaçar un repositori', repo_url: 'URL del repositori', repo_branch: 'Branca (opcional)',
    repo_remove: 'Desenllaçar',
    repo_note: "Només es guarda l'enllaç. Cada IA llegeix el codi amb el seu propi connector de GitHub, que sempre estarà més al dia que una còpia nostra.",
    e_file_too_big: 'Els fitxers poden fer fins a {mb} MB.',
    e_project_full: 'Aquest projecte ja no té espai per a més fitxers.',
    e_bad_repo: "Un enllaç de repositori comença per http:// o https://.",
    t_uploaded: '{n} pujat.', t_file_deleted: '«{n}» esborrat.', t_repo_added: 'Repositori enllaçat.',
    ...
    ps_invite_help: "Genera un enllaç i envia'l per on vulguis. Qui l'obri entrarà (o es crearà un compte) i serà dins. Caduca en 7 dies.",
  ...
  es: {
    ...
    login_help: 'Entra con tu usuario, o créate una cuenta si es la primera vez.',
    tab_login: 'Entrar', tab_signup: 'Crear cuenta',
    user_label: 'Usuario', pass_label: 'Contraseña',
    signup_hint: 'El usuario es el nombre que verán los demás. La contraseña, 8 caracteres como mínimo.',
    login_go: 'Entrar', signup_go: 'Crear la cuenta', or_google: 'o bien',
    acc_password: 'Cambiar la contraseña',
    pw_title: 'Cambiar la contraseña', pw_current: 'Contraseña actual', pw_new: 'Contraseña nueva',
    pw_repeat: 'Repítela', pw_mismatch: 'Las dos contraseñas nuevas no coinciden.',
    pw_note: 'Se cerrará la sesión en todos los demás navegadores donde hayas entrado.',
    pw_done: 'Contraseña cambiada.',
    e_username_invalid: 'El usuario debe tener de 3 a 30 letras, números, puntos, guiones o guiones bajos, sin espacios.',
    e_password_short: 'La contraseña debe tener {n} caracteres como mínimo.',
    e_username_taken: 'Ese usuario ya existe.',
    e_bad_credentials: 'Usuario o contraseña incorrectos.',
    e_too_many: 'Demasiados intentos. Espera unos minutos y vuelve a probar.',
    e_bad_current: 'La contraseña actual no es correcta.',
    e_owns_shared: 'Todavía eres propietario de proyectos con más gente: {names}. Pásalos a otra persona o bórralos antes.',
    ...
    join_btn: 'Unirse al proyecto', join_google: 'Entra o crea una cuenta para unirte',
    ...
    files: 'Archivos', no_files: 'Ningún archivo todavía.', f_upload: 'Subir archivos',
    f_uploading: 'Subiendo…', f_added_by: 'por {n}', f_version: 'v{v}',
    t_updated: '{n} actualizado a v{v}.',
    f_text: 'se puede leer', f_image: 'imagen', f_binary: 'solo descargar',
    f_empty: 'sin texto (¿escaneado?)', f_error: 'no se ha podido leer',
    f_delete: 'Borrar', f_delete_q: '¿Borrar «{n}»?',
    f_delete_body: 'El archivo desaparecerá del proyecto y las IAs dejarán de poder leerlo. La entrada del registro que dice que lo subiste se queda.',
    f_open: 'Abrir',
    repos: 'Repositorios', no_repos: 'Ningún repositorio enlazado.',
    repo_add: 'Enlazar un repositorio', repo_url: 'URL del repositorio', repo_branch: 'Rama (opcional)',
    repo_remove: 'Desenlazar',
    repo_note: 'Solo se guarda el enlace. Cada IA lee el código con su propio conector de GitHub, que siempre estará más al día que una copia nuestra.',
    e_file_too_big: 'Los archivos pueden pesar hasta {mb} MB.',
    e_project_full: 'Este proyecto ya no tiene espacio para más archivos.',
    e_bad_repo: 'Un enlace de repositorio empieza por http:// o https://.',
    t_uploaded: '{n} subido.', t_file_deleted: '«{n}» borrado.', t_repo_added: 'Repositorio enlazado.',
    ...
    ps_invite_help: 'Genera un enlace y envíalo por donde quieras. Quien lo abra entrará (o se creará una cuenta) y estará dentro. Caduca en 7 días.',
  ...
  en: {
    ...
    login_help: 'Sign in with your username, or create an account if this is your first time.',
    tab_login: 'Sign in', tab_signup: 'Create account',
    user_label: 'Username', pass_label: 'Password',
    signup_hint: 'Your username is the name others will see. Passwords need at least 8 characters.',
    login_go: 'Sign in', signup_go: 'Create the account', or_google: 'or',
    acc_password: 'Change password',
    pw_title: 'Change password', pw_current: 'Current password', pw_new: 'New password',
    pw_repeat: 'Repeat it', pw_mismatch: 'The two new passwords do not match.',
    pw_note: 'Every other browser you are signed in on will be signed out.',
    pw_done: 'Password changed.',
    e_username_invalid: 'A username is 3 to 30 letters, numbers, dots, dashes or underscores, with no spaces.',
    e_password_short: 'A password needs at least {n} characters.',
    e_username_taken: 'That username is taken.',
    e_bad_credentials: 'Wrong username or password.',
    e_too_many: 'Too many attempts. Wait a few minutes and try again.',
    e_bad_current: 'The current password is not right.',
    e_owns_shared: 'You still own projects other people are in: {names}. Hand them to someone else, or delete them, first.',
    ...
    join_btn: 'Join the project', join_google: 'Sign in or create an account to join',
    ...
    files: 'Files', no_files: 'No files yet.', f_upload: 'Upload files',
    f_uploading: 'Uploading…', f_added_by: 'by {n}', f_version: 'v{v}',
    t_updated: '{n} updated to v{v}.',
    f_text: 'readable', f_image: 'image', f_binary: 'download only',
    f_empty: 'no text in it (scanned?)', f_error: 'could not be read',
    f_delete: 'Delete', f_delete_q: 'Delete “{n}”?',
    f_delete_body: 'The file leaves the project and assistants stop being able to read it. The log entry saying you added it stays.',
    f_open: 'Open',
    repos: 'Repositories', no_repos: 'No repository linked.',
    repo_add: 'Link a repository', repo_url: 'Repository URL', repo_branch: 'Branch (optional)',
    repo_remove: 'Unlink',
    repo_note: 'Only the link is stored. Each assistant reads the code through its own GitHub connector, which will always be more current than a copy of ours.',
    e_file_too_big: 'Files go up to {mb} MB.',
    e_project_full: 'This project has no room left for more files.',
    e_bad_repo: 'A repository link starts with http:// or https://.',
    t_uploaded: '{n} uploaded.', t_file_deleted: '“{n}” deleted.', t_repo_added: 'Repository linked.',
    ...
    ps_invites: 'Invites',
    ps_invite_help: 'Make a link and send it however you like. Whoever opens it signs in (or creates an account) and is in. It expires in 7 days.',
